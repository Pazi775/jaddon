    ...
    public void execute(CommandSender sender, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("reload")) {
            ...
            if (to != null) {
                ...
                to.sendMessage("Администратор " + who.getName() + " начал на вас проверку.");
            ...
            if (to != null) {
                ...
                to.sendMessage("Администратор " + who.getName() + " прекратил вашу проверку.");
                sender.sendMessage(JCADDONS.getInstance().getConfig().getString("messages.uncheckyes").replace("&", "§"));
            }
        } else sender.sendMessage("Команда введена не правильно.");
    }
